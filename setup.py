...
class NPM(Command):
    ...
    targets = [
        os.path.join(here, 'ipywebrtc', 'static', 'extension.js'),
        os.path.join(here, 'ipywebrtc', 'static', 'index.js')
    ]
...
version_ns = {}
with open(os.path.join(here, 'ipywebrtc', '_version.py')) as f:
